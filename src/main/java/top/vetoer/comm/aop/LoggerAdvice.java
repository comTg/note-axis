...
public class LoggerAdvice {
    ...
    @Before("within(top.vetoer..*) && @annotation(loggerManage)")
    ...
    @AfterReturning("within(top.vetoer..*) && @annotation(loggerManage)")
    public void addAfterReturningLogger(JoinPoint joinPoint, LoggerManage loggerManage) {
        logger.info("执行 " + loggerManage.description() + " 结束");
    }

    @AfterThrowing(pointcut = "within(top.vetoer..*) && @annotation(loggerManage)", throwing = "ex")
